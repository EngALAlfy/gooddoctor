...
class ExitedAppointments extends Component
{
    ...
    {
        return view('livewire.exited-appointments', ['appointments' => Appointment::where('status', 'exited')->where('id', 'LIKE', '%' . $this->search . '%')->orderBy('date', 'desc')->orderBy($this->orderBy, $this->order)->paginate($this->perPage)]);
    }
