<div>
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            @if ($appointment_types == null || count($appointment_types) <= 0)
                        ...
                        @foreach ($appointment_types as $appointment_type)
                            <tr>
                                ...
                                View
                                    ...
                                    @if ($delete_dialog)
                                        <button wire:click="deleteId({{ $appointment_type->id }})" data-target="#delete-modal"
                                    ...
                                    @else
                                        @if ($deleteId == $appointment_type->id)
                                        ...
                                        @else
                                            <button wire:click="deleteId({{ $appointment_type->id }})"
        ...
        <div class="card-footer clearfix">
            <span class="float-left">{{ $appointment_types->links() }}</span>
    ...
    @livewire('create-appointment-type')
    ...
    @include('appointment-types.delete')
    <!-- /.modal -->
</div>
