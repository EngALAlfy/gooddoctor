                        ...
                        <div class="tab-content">
                                                        ...
                                                        <div class="card card-primary card-outline">
                                                            <div class="card-header">
                                                                ...
                                                                <div class="card-tools">
                                                                    ...
                                                                    <button
                                                                        wire:click="removeHistoryDisease({{ $current_appointment->id }} , {{ $history->id }})"
                                                                        class="btn btn-tool">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                <input type="number" id="pulse" autofocus
                                                                    ...
                                                                    wire:keydown.enter="updatePatientCard({{ $current_appointment->id }})"
                                                        ...
                                                        @foreach ($current_appointment->diseases as $disease)
                                                            <li>
                                                                <div class="d-flex"><a class="d-block w-100 collapsed"
                                                                    ...
                                                                    <button
                                                                        wire:click="removeDisease({{ $current_appointment->id }} , {{ $disease->id }})"
                                                                        class="btn btn-tool">
                                                                        <i class="fas fa-trash"></i>
                                                                    </button>
                                                                </div>
                                                        ...
                                                        @foreach ($current_appointment->rays as $ray)
                                                            <li>
                                                                <div class="d-flex">
                                                                    ...
                                                                    <button
                                                                        wire:click="removeRay({{ $current_appointment->id }} , {{ $ray->id }})"
                                                                        class="btn btn-tool">
                                                                        <i class="fas fa-trash"></i>
                                                                    </button>
                                                                </div>
                                                        ...
                                                        @foreach ($current_appointment->tests as $test)
                                                            <li>
                                                                <div class="d-flex">
                                                                    ...
                                                                    <button
                                                                        wire:click="removeTest({{ $current_appointment->id }} , {{ $test->id }})"
                                                                        class="btn btn-tool">
                                                                        <i class="fas fa-trash"></i>
                                                                    </button>
                                                                </div>
                            ...
                            <div class="{{ $tab == 'recipe' ? 'active' : '' }} tab-pane" id="recipe">
                                ...
                                <div class="card card-secondary h-100">
                                    <div class="card-header">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-3 ">
                                                    <input type="text"
                                                        wire:keydown.enter="addDrugToRecipe({{ $current_appointment->id }})"
                                    ...
                                    <div class="card-body">
                                        @if (!$current_appointment->recipe || count($current_appointment->recipe->drugs) <= 0)
                                            <div class="alert alert-info m-l-10 m-r-10">
                                                <h6><i class="icon fas fa-info"></i> @lang('all.no_data')</h6>
                                            </div>
                                        @else
                                            <ul dir="ltr" class="text-left">
                                                @foreach ($current_appointment->recipe->drugs as $drug)
                                                    <li class="drug-recipe">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <button
                                                                wire:click="removeDrugFromRecipe({{ $current_appointment->id }} , {{ $drug->id }})"
                                                                class="btn btn-tool">
                                                                <i class="fas fa-trash"></i>
                                                            </button>
                                                        </div>
                            ...
                            <div class="{{ $tab == 'instructions' ? 'active' : '' }} tab-pane" id="instructions">
                                ...
                                @if (!$current_appointment->instructions)
                                    <div class="alert alert-info m-l-10 m-r-10">
                                        <h6><i class="icon fas fa-info"></i> @lang('all.no_data')</h6>
                                    </div>
                                @else
                                    <div class="card card-primary">
                                        <div class="card-header ">
                                            <h5 class="card-title">
                                                {{ $current_appointment->instructions->name }}
                                            </h5>
                                            <div class="card-tools">
                                                <button
                                                    wire:click="removeInstructions({{ $current_appointment->id }})"
                                                    class="btn btn-tool"><i class="fa fa-times"></i></button>
                                            </div>
                                        </div>

                                        <div class="card-body">
                                            {!! str_replace("\n", '<br/>', $current_appointment->instructions->list) !!}
                                        </div>
                                    </div>
                                @endif
            ...
            <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default"
                            data-dismiss="modal">@lang('all.cancel')</button>
                        <button wire:click="updateSymptoms({{ $current_appointment->id }})" class="btn btn-primary">
                            @lang('all.save')
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default"
                            data-dismiss="modal">@lang('all.cancel')</button>
                        <button wire:click="addHistoryDisease({{ $current_appointment->id }})"
            ...
            <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default"
                            data-dismiss="modal">@lang('all.cancel')</button>
                        <button wire:click="addTest({{ $current_appointment->id }})" class="btn btn-primary">
                            @lang('all.save')
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default"
                            data-dismiss="modal">@lang('all.cancel')</button>
                        <button wire:click="addRay({{ $current_appointment->id }})" class="btn btn-primary">
                            @lang('all.save')
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default"
                            data-dismiss="modal">@lang('all.cancel')</button>
                        <button wire:click="addInstructions({{ $current_appointment->id }})"
                            class="btn btn-primary">
                            @lang('all.save')
                        </button>
                    </div>
    ...
    @push('scripts')
        <script>
            ...
            function showEditSymptomsModal() {
                @if ($current_appointment)
                    @this.symptoms = @js($current_appointment->symptoms);
                @endif
