<div>
    ...
    <div class="card">
                        ...
                        @foreach ($diseases as $disease)
                            <tr>
                                ...
                                View
                                    ...
                                    @if ($delete_dialog)
                                        <button wire:click="deleteId({{ $disease->id }})" data-target="#delete-modal"
                                    ...
                                    @else
                                        ...
                                        @else
                                            <button wire:click="deleteId({{ $disease->id }})"
        ...
        <div class="card-footer clearfix">
            <span class="float-left">{{ $diseases->links() }}</span>
